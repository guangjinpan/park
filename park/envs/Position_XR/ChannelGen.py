...
class Channel():
    def __init__(self, BS_number=4, User_number = 10, bandwidth_total = 10e6, Radius = 1000, rmin = 30,power=1e4):
    ...
    def generateSNR(self,):
        ...
        for i in range(self.BS_number):
            for j in range(self.User_number):
                ...
                SNR[i,j]=self.power*self.channel_gain[i,j]/(interference+self.noise[i,j])
        return SNR
