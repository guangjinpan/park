...
class PositionXREnv(core.Env):
    ...
    * REFERENCE *
    ...
    """
    def __init__(self, BS_number=4, User_number = 10, bandwidth_total = 10e8,Radius = 1000, rmin = 30 ):
        # set up seed
        ...
        print(self.channel_gain)
        print(self.channel_gain.shape)
    ...
    def observe(self):
        ...
        obs_arr[:,:]=self.channel_gain.copy()
    ...
    def setup_space(self):
        ...
        self.action_low = np.array([0] * (self.User_number+ self.BS_number * self.User_number))
        self.action_high = np.array([1]* (self.User_number+ self.BS_number * self.User_number))               
